    ...
    <div className="relative">
      ...
      >
        ...
        <span className="mr-1 block font-medium text-theme-sm">
          {user.isLoading ? 'Loading...' : user?.name || 'User'}
        </span>
      ...
      >
        <div>
          ...
          <span className="mt-0.5 block text-gray-500 text-theme-xs dark:text-gray-400">
            {user.isLoading ? '...' : user?.email || 'user@example.com'}
          </span>
        </div>

        <ul className="flex flex-col gap-1 border-gray-200 border-b pt-4 pb-3 dark:border-gray-800">
          <li>
            <DropdownItem
          ...
          <li>
            ...
            >
              ...
              >
                <path
                  clipRule="evenodd"
                  d="M10.4858 3.5L13.5182 3.5C13.9233 3.5 14.2518 3.82851 14.2518 4.23377C14.2518 5.9529 16.1129 7.02795 17.602 6.1682C17.9528 5.96567 18.4014 6.08586 18.6039 6.43667L20.1203 9.0631C20.3229 9.41407 20.2027 9.86286 19.8517 10.0655C18.3625 10.9253 18.3625 13.0747 19.8517 13.9345C20.2026 14.1372 20.3229 14.5859 17.7782 17.5634C17.4854 17.8142 17.0368 17.694 16.786 17.3432C15.2969 15.4835 13.4358 14.4084 13.4358 12.6893C13.4358 12.2841 13.1073 11.9556 12.7022 11.9556H9.69818C9.29303 11.9556 8.96452 12.2841 8.96452 12.6893C8.96452 14.4084 7.10336 15.4835 5.61422 17.3432C6.17279 15.3096 8.24852 13.5955 10.7246 13.5955H13.2746C15.7509 13.5955 17.8268 15.31 18.38 17.6167C19.6996 16.119 20.5 14.153 20.5 12C20.5 7.30558 16.6944 3.5 12 3.5ZM17.0246 18.8566V18.8455C17.0246 16.7744 15.3457 15.0955 13.2746 15.0955H10.7246C8.65354 15.0955 6.97461 16.7744 6.97461 18.8455V18.856C8.38223 19.8895 10.1198 20.5 12 20.5C13.8798 20.5 15.6171 19.8898 17.0246 18.8566ZM11.9991 7.25C10.8847 7.25 9.98126 8.15342 9.98126 9.26784C9.98126 10.3823 10.8847 11.2857 11.9991 11.2857C13.1135 11.2857 14.0169 10.3823 14.0169 9.26784C14.0169 8.15342 13.1135 7.25 11.9991 7.25ZM8.48126 9.26784C8.48126 7.32499 10.0563 5.75 11.9991 5.75C13.9419 5.75 15.5169 7.32499 15.5169 9.26784C15.5169 11.2107 13.9419 12.7857 11.9991 12.7857C10.0563 12.7857 8.48126 11.2107 8.48126 9.26784Z"
                  fill=""
                  fillRule="evenodd"
                />
              </svg>
