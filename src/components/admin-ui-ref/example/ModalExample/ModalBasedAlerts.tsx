    ...
    <ComponentCard title="Modal Based Alerts">
      ...
      >
        <div className="text-center">
          ...
          <div className="mt-7 flex w-full items-center justify-center gap-3">
            <button
              className="flex w-full justify-center rounded-lg bg-success-500 px-4 py-3 font-medium text-sm text-white shadow-theme-xs hover:bg-success-600 sm:w-auto"
              type="button"
            >
              Okay, Got It
            </button>
      ...
      >
        <div className="text-center">
          ...
          <div className="mt-7 flex w-full items-center justify-center gap-3">
            <button
              className="flex w-full justify-center rounded-lg bg-blue-light-500 px-4 py-3 font-medium text-sm text-white shadow-theme-xs hover:bg-blue-light-600 sm:w-auto"
              type="button"
            >
              Okay, Got It
            </button>
      ...
      >
        <div className="text-center">
          ...
          <div className="mt-7 flex w-full items-center justify-center gap-3">
            <button
              className="flex w-full justify-center rounded-lg bg-warning-500 px-4 py-3 font-medium text-sm text-white shadow-theme-xs hover:bg-warning-600 sm:w-auto"
              type="button"
            >
              Okay, Got It
            </button>
      ...
      >
        <div className="text-center">
          ...
          <div className="mt-7 flex w-full items-center justify-center gap-3">
            <button
              className="flex w-full justify-center rounded-lg bg-error-500 px-4 py-3 font-medium text-sm text-white shadow-theme-xs hover:bg-error-600 sm:w-auto"
              type="button"
            >
              Okay, Got It
            </button>
