        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex w-full flex-col items-center gap-6 xl:flex-row">
            ...
            <div className="order-2 flex grow items-center gap-2 xl:order-3 xl:justify-end">
              <a
                className="flex h-11 w-11 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white font-medium text-gray-700 text-sm shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/3 dark:hover:text-gray-200"
          ...
          {lastUpdated && (
            <p className="text-center text-gray-500 text-sm xl:text-left dark:text-gray-400">
