          ...
          <div className="hidden lg:block">
            <form>
              <div className="relative">
                <span className="-translate-y-1/2 pointer-events-none absolute top-1/2 left-4">
                  <svg
                ...
                <input
                  className="h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pr-14 pl-12 text-gray-800 text-sm shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 xl:w-[430px] dark:border-gray-800 dark:bg-dark-900 dark:bg-gray-900 dark:bg-white/3 dark:text-white/90 dark:focus:border-brand-800 dark:placeholder:text-white/30"
                  placeholder="Search or type command..."
                  ref={inputRef}
                  type="text"
                />

                <button className="-translate-y-1/2 -tracking-[0.2px] absolute top-1/2 right-2.5 inline-flex items-center gap-0.5 rounded-lg border border-gray-200 bg-gray-50 px-[7px] py-[4.5px] text-gray-500 text-xs dark:border-gray-800 dark:bg-white/3 dark:text-gray-400">
                  <span> ⌘ </span>
                  <span> K </span>
                </button>
              </div>
